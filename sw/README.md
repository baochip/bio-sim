...
Add the `"-Demit-listing=true"` argument if you plan to use the `codezoom` feature to correlate your waveform traces to source code.
...
### Generating Disassembly Listings
